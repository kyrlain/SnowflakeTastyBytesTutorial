...
-- Exploring the Tasty Bytes Database
USE ROLE sysadmin;
SHOW DATABASES LIKE 'tb_101';

-- Exploring the Schemas within the Tasty Bytes Database
SHOW SCHEMAS IN DATABASE tb_101;

-- Exploring the Tables within the RAW_POS Schema within the Tasty Bytes Database
SHOW TABLES IN SCHEMA tb_101.raw_pos;

-- Exploring the Tasty Bytes Roles
SHOW ROLES LIKE 'tb%';

-- Exploring the Tasty Bytes Warehouses
