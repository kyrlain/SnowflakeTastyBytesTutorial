...
ALTER SESSION SET query_tag = '{"origin":"sf_sit-is","name":"tb_zts","version":{"major":1, "minor":1},"attributes":{"is_quickstart":1, "source":"sql", "vignette": "geospatial"}}';
...
SET center_point = '{"coordinates": [2.331425538168034e+00, 4.885940799465190e+01], "type": "Point"}';
...
SELECT H3_GRID_DISTANCE('871fb4671ffffff', '871fb4662ffffff') AS cell_distance;
